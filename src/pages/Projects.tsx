          ...
          <div id="projRepairWrapper" className="projWrapper">
            <div id="projRepairContainer" className={`projContainer ${onScreen[0]}`}>
              <div id="projRepairTextContainer" className="projTextContainer">
                ...
                <p id="projRepairText" className={`projText ${onScreen[0]}`}>At Golden Grove Bicycle Company, we understand how important your bike is to you. Our team of experienced technicians are dedicated to providing top-notch repair services to get your bicycle back on the road quickly and safely.</p>
              </div>
          ...
          <div id="projMaintenanceWrapper" className="projWrapper">
            <div id="projMaintenanceContainer" className={`projContainer ${onScreen[1]}`}>
              <div id="projMaintenanceTextContainer" className="projTextContainer">
                ...
                <p id="projMaintenanceText" className={`projText ${onScreen[1]}`}>From routine tune-ups to major overhauls, we offer comprehensive maintenance services to keep your bike running smoothly. Our experts will thoroughly inspect your bicycle and make any necessary adjustments or replacements to ensure optimal performance.</p>
              </div>
          ...
          <div id="projServiceWrapper" className="projWrapper">
            <div id="projServiceContainer" className={`projContainer ${onScreen[2]}`}>
              <div id="projServiceTextContainer" className="projTextContainer">
                ...
                <p id="projServiceText" className={`projText ${onScreen[2]}`}>At Golden Grove Bicycle Company, we understand that every bike and rider is unique. That’s why we take the time to get to know you and your cycling needs, and provide personalized solutions to keep you riding with confidence.</p>
              </div>
