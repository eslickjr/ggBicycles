        ...
        <footer id="theFooter" className="footer">
            <div id="footerInfoContainer">
                <div id="footerSocialMedias">
                    <div id="footerLogo" role="link" aria-label="Golden Grove Bicycle Co. home" onClick={() => {navigate('/')}}/>
                    <p id="footerTagline">Honest, expert bicycle repair and maintenance in Piedmont, SC.</p>
                    <div id="socialMediaContainer">
                        <Link to="https://www.facebook.com/GGBicycleCo" aria-label="Facebook" className="socialLink" target="_blank" rel="noopener noreferrer">
                        ...
                        <Link to="https://www.instagram.com/goldengrovebicyclecompany/" aria-label="Instagram" className="socialLink" target="_blank" rel="noopener noreferrer">
                ...
                <div id="footerContact">
                    <h4 id="footerContactTitle">Get in touch</h4>
            ...
            <div id="footerBottom">
                <p id="developerInfo">
                    &copy; {new Date().getFullYear()} Golden Grove Bicycle Company{!mobile ? <span>&nbsp;&middot;&nbsp;</span> : <br />}Design &amp; development by&nbsp;
