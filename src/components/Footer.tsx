            ...
            <div id="footerInfoContainer">
                <div id="footerSocialMedias">
                    ...
                    <div id="socialMediaContainer">
                        <Link to="https://www.facebook.com/goldengrovebicycles/" target="_blank" rel="noopener noreferrer">
                        ...
                        <Link to="https://www.instagram.com/goldengrovebicycles/" target="_blank" rel="noopener noreferrer">
                ...
                <div id="footerContact">
                    ...
                    <p id="footerEmail" className="footerInfo">
                        ...
                        GGBicycleCo@gmail.com
                    </p>
                </div>
            </div>
            <p id="developerInfo">
                Golden Grove Bicycle Company 2025 Design & Developed by&nbsp;
